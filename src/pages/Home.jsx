...
export default function Home() {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-white text-center px-4 relative overflow-hidden">
      ...
      <div className="space-x-4 mt-4">
        <button
          ...
          className="bg-linear-to-r from-purple-700 to-pink-500 text-gray-900 px-8 py-3 rounded-full font-bold shadow-lg hover:bg-yellow-300 transition hover:scale-105 outline-none focus-visible:ring-4 focus-visible:ring-pink-400"
        >
          View My Work
        </button>
        <button
          onClick={() => scrollToSection("contact")}
          className="border border-white/70 px-8 py-3 rounded-full font-bold shadow-lg hover:bg-white hover:text-gray-900 hover:scale-105 transition outline-none focus-visible:ring-4 focus-visible:ring-yellow-300"
        >
          Contact Me
        </button>
      </div>
