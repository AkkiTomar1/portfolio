...
export default function Projects() {
  ...
  return (
    <section className="min-h-screen py-20 px-6">
      ...
      <div className="relative max-w-6xl mx-auto grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10 z-10">
        {projects.map((project, i) => (
          <div key={i} className="transition-transform duration-300 hover:-translate-y-2 hover:scale-105">
            <ProjectCard {...project} />
          </div>
        ))}
      </div>
